       ...
       return EnemyAI(parent:parent, startingState:"Idle", withStates: [
        State(name: "Idle",
            ...
            behaviors: [
                ...
                MainAttack(parent: parent, error: 1, triggerDistance: 20, rateOfFire: 200, projectileTexture: SKTextureAtlas(named: "InGameIcons").textureNamed("ProjectileA0"), projectileSpeed: 50, range: 40, priority: 5),
